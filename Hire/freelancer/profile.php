        ...
        <div class="container px-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#!">Devs</a></li>
        ...
        <main>
            <div class="container">
                ...
                <div class="row justify-content-center">
                    ...
                    <!-- col 5 -->
                    <div class="col-lg-5">
                        <div class="card border-0 rounded-lg mt-5 shadow-lg">
                            <div class="card-body">
                        ...
                        <!-- 2 -->
                        <div class="card border-0 rounded-lg mt-3  shadow-lg">
                            <div class="card-body">
                                <div class="main-header">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <p class="text-muted text-primary ml-2" style="font-size: 16px;">NOTE: if You Disable Your Account You Can't Enable Again Until the Admin Approves Your request</p>
                        ...
                        <button type="button" class="btn btn-success saveChanges bg-success border-1 border-light text-white my-3">Save Changes</button>
...
<div class="modal fade bd-example-modal-lg passModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        ...
        $(".disable").click((e) => {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    swalWithBootstrapButtons.fire(
                        'Cancelled',
                        'Disabled Mode Has Been Cancled :)',
                        'info'
                    )
                }
            })
